<template>
    <div class="flex flex-col h-screen items-center justify-center relative">
      ...
      <div class="absolute top-24 font-bold text-lg mt-80">
        <p>{{ currentTime.timezone }}</p>
        <!-- <TimezonePicker /> -->
      </div>
      <!-- the "clock" -->
      <div
        class="flex flex-col items-center justify-center w-60 h-24 m-auto px-8 border-black border-8 rounded-xl shadow-xl relative"
      >
