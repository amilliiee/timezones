<template>
  <div class="flex flex-col h-screen items-center justify-center relative">
    ...
    <div
      class="absolute top-24 font-bold text-lg mt-80 w-60 h-10 border-black border-4 rounded-lg bg-gray-100"
    >
      <p class="text-center">{{ currentTime.timezone }}</p>
    </div>
    <!-- the "clock" -->
    <div
    ...
    >
      ...
      <p class="font-bold py-4 text-5xl">
        <!-- {{ currentTime.time.toLocaleTimeString().slice(0, -6) }} -->
